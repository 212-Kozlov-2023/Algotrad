A {\bfseries{matcher}} matches a {\itshape single} argument. You can use it inside {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{ON\+\_\+\+CALL()}}} or {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{EXPECT\+\_\+\+CALL()}}}, or use it to validate a value directly using two macros\+:
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, matcher)}}}   &Asserts that {\ttfamily actual\+\_\+value} matches {\ttfamily matcher}.    \\\cline{1-2}
{\ttfamily \mbox{\hyperlink{gmock-matchers_8h_a41d888579850c16583baea33ee8d057e}{ASSERT\+\_\+\+THAT(actual\+\_\+value, matcher)}}}   &The same as {\ttfamily \mbox{\hyperlink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, matcher)}}}, except that it generates a {\bfseries{fatal}} failure.   \\\cline{1-2}
\end{longtabu}


\{\+: .callout .warning\} {\bfseries{WARNING\+:}} Equality matching via {\ttfamily \mbox{\hyperlink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, expected\+\_\+value)}}} is supported, however note that implicit conversions can cause surprising results. For example, {\ttfamily EXPECT\+\_\+\+THAT(some\+\_\+bool, \char`\"{}some string\char`\"{})} will compile and may pass unintentionally.

{\bfseries{BEST PRACTICE\+:}} Prefer to make the comparison explicit via {\ttfamily \mbox{\hyperlink{gmock-matchers_8h_ac31e206123aa702e1152bb2735b31409}{EXPECT\+\_\+\+THAT(actual\+\_\+value, Eq(expected\+\_\+value))}}} or {\ttfamily EXPECT\+\_\+\+EQ(actual\+\_\+value, expected\+\_\+value)}.

Built-\/in matchers (where {\ttfamily argument} is the function argument, e.\+g. {\ttfamily actual\+\_\+value} in the example above, or when used in the context of {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a535a6156de72c1a2e25a127e38ee5232}{EXPECT\+\_\+\+CALL(mock\+\_\+object, method(matchers))}}}, the arguments of {\ttfamily method}) are divided into several categories. All matchers are defined in the {\ttfamily \mbox{\hyperlink{namespacetesting}{testing}}} namespace unless otherwise noted.\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md330}{}\doxysection{Wildcard}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md330}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md331}{}\doxysection{Generic Comparison}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md331}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_a527b9bcc13669b9a16400c8514266254}{Is\+True()}}}   &{\ttfamily argument} evaluates to {\ttfamily true} in a Boolean context.    \\\cline{1-2}
{\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_adcfd37a66bc4cb0e8291cf46e1a6c72b}{Is\+Null()}}}   &{\ttfamily argument} is a {\ttfamily NULL} pointer (raw or smart).    \\\cline{1-2}
...
{\ttfamily Is\+True} and {\ttfamily Is\+False} are useful when you need to use a matcher, or for types that can be explicitly converted to Boolean, but are not implicitly converted to Boolean. In other cases, you can use the basic \href{assertions.md\#boolean}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE} and {\ttfamily EXPECT\+\_\+\+FALSE}}} assertions.\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_FpMatchers}{}\doxysection{Floating-\/\+Point Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_FpMatchers}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
The above matchers use ULP-\/based comparison (the same as used in googletest). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the IEEE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md332}{}\doxysection{String Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md332}
...
{\ttfamily \mbox{\hyperlink{namespacetesting_af5865f00c5541200d8f6872c52ed2446}{Is\+Empty()}}}   &{\ttfamily argument} is an empty string.    \\\cline{1-2}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} take ownership of the {\ttfamily RE} object. They use the regular expression syntax defined \href{../advanced.md\#regular-expression-syntax}{\texttt{ here}}. All of these matchers, except {\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} work for wide strings as well.\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md333}{}\doxysection{Container Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md333}
...
{\ttfamily \mbox{\hyperlink{namespacetesting_af5865f00c5541200d8f6872c52ed2446}{Is\+Empty()}}}   &{\ttfamily argument} is an empty container ({\ttfamily \mbox{\hyperlink{namespacegoogle__benchmark_1_1example_a1308c65820150fa43f5d1a1c9b7432da}{container.\+empty()}}}).    \\\cline{1-2}
...
\`{}\`{}\`{}cpp MATCHER(Foo\+Eq, \char`\"{}\char`\"{}) \{ return std\+::get$<$0$>$(arg).Equals(std\+::get$<$1$>$(arg)); \} ... EXPECT\+\_\+\+THAT(actual\+\_\+foos, Pointwise(\+Foo\+Eq(), expected\+\_\+foos)); \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md334}{}\doxysection{Member Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md334}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\`{}\`{}\`{}cpp std\+::tuple$<$int, std\+::string$>$ my\+\_\+tuple\{7, \char`\"{}hello world\char`\"{}\}; EXPECT\+\_\+\+THAT(my\+\_\+tuple, Fields\+Are(Ge(0), Has\+Substr(\char`\"{}hello\char`\"{})));

struct My\+Struct \{ int value = 42; std\+::string greeting = \char`\"{}aloha\char`\"{}; \}; My\+Struct s; EXPECT\+\_\+\+THAT(s, Fields\+Are(42, \char`\"{}aloha\char`\"{})); \`{}\`{}\`{}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md335}{}\doxysection{Matching the Result of a Function, Functor, or Callback}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md335}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md336}{}\doxysection{Pointer Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md336}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_MultiArgMatchers}{}\doxysection{Multi-\/argument Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_MultiArgMatchers}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md337}{}\doxysection{Composite Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md337}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md338}{}\doxysection{Adapters for Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md338}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
{\ttfamily Address\+Satisfies(callback)} and {\ttfamily Truly(callback)} take ownership of {\ttfamily callback}, which must be a permanent callback.\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_MatchersAsPredicatesCheat}{}\doxysection{Using Matchers as Predicates}\label{md_build__deps_googletest_src_docs_reference_matchers_MatchersAsPredicatesCheat}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Matcher   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md339}{}\doxysection{Defining Matchers}\label{md_build__deps_googletest_src_docs_reference_matchers_autotoc_md339}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily MATCHER(Is\+Even, \char`\"{}\char`\"{}) \{ return (arg \% 2) == 0; \}}   &Defines a matcher {\ttfamily Is\+Even()} to match an even number.    \\\cline{1-2}
{\ttfamily MATCHER\+\_\+P(Is\+Divisible\+By, n, \char`\"{}\char`\"{}) \{ $\ast$result\+\_\+listener $<$$<$ \char`\"{}where the remainder is \char`\"{} $<$$<$ (arg \% n); return (arg \% n) == 0; \}}   &Defines a matcher {\ttfamily Is\+Divisible\+By(n)} to match a number divisible by {\ttfamily n}.    \\\cline{1-2}
{\ttfamily MATCHER\+\_\+\+P2(Is\+Between, a, b, absl\+::\+Str\+Cat(negation ? \char`\"{}isn\textquotesingle{}t\char`\"{} \+: \char`\"{}is\char`\"{}, \char`\"{} between \char`\"{}, Print\+To\+String(a), \char`\"{} and \char`\"{}, Print\+To\+String(b))) \{ return a $<$= arg \&\& arg $<$= b; \}}   &Defines a matcher {\ttfamily Is\+Between(a, b)} to match a value in the range \mbox{[}{\ttfamily a}, {\ttfamily b}\mbox{]}.   \\\cline{1-2}
\end{longtabu}
...
\begin{DoxyEnumerate}
\item The {\ttfamily MATCHER$\ast$} macros cannot be used inside a function or class.
...
\`{}\`{}\`{}cpp MATCHER\+\_\+P(Nested\+Property\+Matches, matcher, \char`\"{}\char`\"{}) \{ return Explain\+Match\+Result(matcher, arg.\+nested().property(), result\+\_\+listener); \} \`{}\`{}\`{}
\item You can use {\ttfamily Describe\+Matcher$<$$>$} to describe another matcher. For example\+:

\`{}\`{}\`{}cpp MATCHER\+\_\+P(XAnd\+YThat, matcher, \char`\"{}\+X that \char`\"{} + Describe\+Matcher$<$int$>$(matcher, negation) + (negation ? \char`\"{} or\char`\"{} \+: \char`\"{} and\char`\"{}) + \char`\"{} Y that \char`\"{} + Describe\+Matcher$<$double$>$(matcher, negation)) \{ return Explain\+Match\+Result(matcher, arg.\+x(), result\+\_\+listener) \&\& Explain\+Match\+Result(matcher, arg.\+y(), result\+\_\+listener); \} \`{}\`{}\`{} 
\end{DoxyEnumerate}