\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md88}{}\doxysection{Introduction}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md88}
Now that you have read the \mbox{\hyperlink{md_build__deps_googletest_src_docs_primer}{Google\+Test Primer}} and learned how to write tests using Google\+Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md89}{}\doxysection{More Assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md89}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md90}{}\doxysubsection{Explicit Success and Failure}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md90}
See \href{reference/assertions.md\#success-failure}{\texttt{ Explicit Success and Failure}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md91}{}\doxysubsection{Exception Assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md91}
See \href{reference/assertions.md\#exceptions}{\texttt{ Exception Assertions}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md92}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md92}
Even though Google\+Test has a rich set of assertions, they can never be complete, as it\textquotesingle{}s impossible (nor a good idea) to anticipate all scenarios a user might run into. Therefore, sometimes a user has to use {\ttfamily \mbox{\hyperlink{gtest_8h_ac33e7cdfb5d44a7a0f0ab552eb5c3c6a}{EXPECT\+\_\+\+TRUE()}}} to check a complex expression, for lack of a better macro. This has the problem of not showing you the values of the parts of the expression, making it hard to understand what went wrong. As a workaround, some users choose to construct the failure message by themselves, streaming it into {\ttfamily \mbox{\hyperlink{gtest_8h_ac33e7cdfb5d44a7a0f0ab552eb5c3c6a}{EXPECT\+\_\+\+TRUE()}}}. However, this is awkward especially when the expression has side-\/effects or is expensive to evaluate.

Google\+Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md93}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md93}
If you already have a function or functor that returns {\ttfamily bool} (or a type that can be implicitly converted to {\ttfamily bool}), you can use it in a {\itshape predicate assertion} to get the function arguments printed for free. See \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} in the Assertions Reference for details.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md94}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md94}
While {\ttfamily EXPECT\+\_\+\+PRED$\ast$()} and friends are handy for a quick job, the syntax is not satisfactory\+: you have to use different macros for different arities, and it feels more like Lisp than C++. The {\ttfamily \+::testing\+::\+Assertion\+Result} class solves this problem.
...
To provide more readable messages in Boolean assertions (e.\+g. {\ttfamily \mbox{\hyperlink{gtest_8h_ac33e7cdfb5d44a7a0f0ab552eb5c3c6a}{EXPECT\+\_\+\+TRUE()}}}), write a predicate function that returns {\ttfamily Assertion\+Result} instead of {\ttfamily bool}. For example, if you define {\ttfamily Is\+Even()} as\+:
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md95}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md95}
If you find the default message generated by \href{reference/assertions.md\#EXPECT_PRED}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED$\ast$}}} and \href{reference/assertions.md\#EXPECT_TRUE}{\texttt{ {\ttfamily EXPECT\+\_\+\+TRUE}}} unsatisfactory, or some arguments to your predicate do not support streaming to {\ttfamily ostream}, you can instead use {\itshape predicate-\/formatter assertions} to {\itshape fully} customize how the message is formatted. See \href{reference/assertions.md\#EXPECT_PRED_FORMAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+PRED\+\_\+\+FORMAT$\ast$}}} in the Assertions Reference for details.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md96}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md96}
See \href{reference/assertions.md\#floating-point}{\texttt{ Floating-\/\+Point Comparison}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md97}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md97}
...
The above code verifies that {\ttfamily val1} is less than, or approximately equal to, {\ttfamily val2}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md98}{}\doxysubsection{Asserting Using g\+Mock Matchers}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md98}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md99}{}\doxysubsection{More String Assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md99}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md100}{}\doxysubsection{Windows HRESULT assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md100}
See \href{reference/assertions.md\#HRESULT}{\texttt{ Windows HRESULT Assertions}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md101}{}\doxysubsection{Type Assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md101}
...
to cause a compiler error.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md102}{}\doxysubsection{Assertion Placement}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md102}
You can use assertions in any C++ function. In particular, it doesn\textquotesingle{}t have to be a method of the test fixture class. The one constraint is that assertions that generate a fatal failure ({\ttfamily FAIL$\ast$} and {\ttfamily ASSERT\+\_\+$\ast$}) can only be used in void-\/returning functions. This is a consequence of Google\textquotesingle{}s not using exceptions. By placing it in a non-\/void function you\textquotesingle{}ll get a confusing compile error like {\ttfamily \char`\"{}error\+: void value not ignored as it ought to be\char`\"{}} or `\char`\"{}cannot initialize return object of type \textquotesingle{}bool' with an rvalue of type \textquotesingle{}void\textquotesingle{}\char`\"{}\`{} or \`{}\char`\"{}error\+: no viable conversion from \textquotesingle{}void\textquotesingle{} to \textquotesingle{}string\textquotesingle{}\char`\"{}\`{}.
...
If changing the function\textquotesingle{}s type is not an option, you should just use assertions that generate non-\/fatal failures, such as {\ttfamily ADD\+\_\+\+FAILURE$\ast$} and {\ttfamily EXPECT\+\_\+$\ast$}.
...
\{\+: .callout .warning\} WARNING\+: A fatal assertion in a helper function (private void-\/returning method) called from a constructor or destructor does not terminate the current test, as your intuition might suggest\+: it merely returns from the constructor or destructor early, possibly leaving your object in a partially-\/constructed or partially-\/destructed state! You almost certainly want to {\ttfamily abort} or use {\ttfamily Set\+Up}/{\ttfamily Tear\+Down} instead.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md103}{}\doxysection{Skipping test execution}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md103}
Related to the assertions {\ttfamily \mbox{\hyperlink{gtest_8h_a75adcdf89f69b0b615e395daafc315af}{SUCCEED()}}} and {\ttfamily \mbox{\hyperlink{gtest_8h_a3e26a8d27caa386ed0ea7ce9d5b7c4ed}{FAIL()}}}, you can prevent further test execution at runtime with the {\ttfamily \mbox{\hyperlink{perf__counters__gtest_8cc_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} macro. This is useful when you need to check for preconditions of the system under test during runtime and skip tests in a meaningful way.

{\ttfamily \mbox{\hyperlink{perf__counters__gtest_8cc_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} can be used in individual test cases or in the {\ttfamily Set\+Up()} methods of classes derived from either {\ttfamily \mbox{\hyperlink{classtesting_1_1Environment}{testing\+::\+Environment}}} or {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}}. For example\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{ \{c++\}}
\DoxyCodeLine{TEST(SkipTest, DoesSkip) \{}
\DoxyCodeLine{  GTEST\_SKIP() << "{}Skipping single test"{};}
\DoxyCodeLine{  EXPECT\_EQ(0, 1);  // Won't fail; it won't be executed}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{class SkipFixture : public ::testing::Test \{}
\DoxyCodeLine{ protected:}
\DoxyCodeLine{  void SetUp() override \{}
\DoxyCodeLine{    GTEST\_SKIP() << "{}Skipping all tests for this fixture"{};}
\DoxyCodeLine{  \}}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{// Tests for SkipFixture won't be executed.}
\DoxyCodeLine{TEST\_F(SkipFixture, SkipsOneTest) \{}
\DoxyCodeLine{  EXPECT\_EQ(5, 7);  // Won't fail}
\DoxyCodeLine{\}}

\end{DoxyCode}


As with assertion macros, you can stream a custom message into {\ttfamily \mbox{\hyperlink{perf__counters__gtest_8cc_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md104}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md104}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out.
...
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{keywordtype}{int} \mbox{\hyperlink{gmock-matchers-containers__test_8cc_a6150e0515f7202e2fb518f7206ed97dc}{x}};}
\DoxyCodeLine{  \textcolor{keywordtype}{int} \mbox{\hyperlink{gmock-matchers-containers__test_8cc_a39cb44155237f0205e0feb931d5acbed}{y}};}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
Sometimes, {\ttfamily Absl\+Stringify()} might not be an option\+: your team may wish to print types with extra debugging information for testing purposes only. If so, you can instead define a {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_adb3c27150dbe661db0e0c4be27533460}{Print\+To()}}} function like this\+:
...
\DoxyCodeLine{}
\DoxyCodeLine{class Point \{}
\DoxyCodeLine{  ...}
\DoxyCodeLine{  friend void PrintTo(const Point\& point, std::ostream* os) \{}
\DoxyCodeLine{    *os << "{}("{} << point.x << "{},"{} << point.y << "{})"{};}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
\DoxyCodeLine{  int x;}
\DoxyCodeLine{  int y;}
...
\DoxyCodeLine{// is defined in the SAME namespace that defines Point.  C++'s look-\/up rules}
\DoxyCodeLine{// rely on that.}
\DoxyCodeLine{void PrintTo(const Point\& point, std::ostream* os) \{}
\DoxyCodeLine{    *os << "{}("{} << point.x << "{},"{} << point.y << "{})"{};}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\}  // namespace foo}
...
If you have defined both {\ttfamily Absl\+Stringify()} and {\ttfamily \mbox{\hyperlink{namespacetesting_1_1internal_adb3c27150dbe661db0e0c4be27533460}{Print\+To()}}}, the latter will be used by Google\+Test. This allows you to customize how the value appears in Google\+Test\textquotesingle{}s output without affecting code that relies on the behavior of {\ttfamily Absl\+Stringify()}.
...
\DoxyCodeLine{    << "{}point\_ints = "{} << testing::PrintToString(point\_ints);}

\end{DoxyCode}


For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md105}{}\doxysection{Death Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md105}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md106}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md106}
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md107}{}\doxysubsection{Death Test Naming}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md107}
\{\+: .callout .important\} IMPORTANT\+: We strongly recommend you to follow the convention of naming your {\bfseries{test suite}} (not test) {\ttfamily $\ast$\+Death\+Test} when it contains a death test, as demonstrated in the above example. The \href{\#death-tests-and-threads}{\texttt{ Death Tests And Threads}} section below explains why.
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md108}{}\doxysubsection{Regular Expression Syntax}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md108}
When built with Bazel and using Abseil, Google\+Test uses the \href{https://github.com/google/re2/wiki/Syntax}{\texttt{ RE2}} syntax. Otherwise, for POSIX systems (Linux, Cygwin, Mac), Google\+Test uses the \href{https://www.opengroup.org/onlinepubs/009695399/basedefs/xbd_chap09.html\#tag_09_04}{\texttt{ POSIX extended regular expression}} syntax. To learn about POSIX syntax, you may want to read this \href{https://en.wikipedia.org/wiki/Regular_expression\#POSIX_extended}{\texttt{ Wikipedia entry}}.
...
To help you determine which capability is available on your system, Google\+Test defines macros to govern which regular expression it is using. The macros are\+: {\ttfamily GTEST\+\_\+\+USES\+\_\+\+SIMPLE\+\_\+\+RE=1} or {\ttfamily GTEST\+\_\+\+USES\+\_\+\+POSIX\+\_\+\+RE=1}. If you want your death tests to work in all cases, you can either {\ttfamily \#if} on these macros or use the more limited syntax only.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md109}{}\doxysubsection{How It Works}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md109}
See \href{reference/assertions.md\#death}{\texttt{ Death Assertions}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md110}{}\doxysubsection{Death Tests And Threads}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md110}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md111}{}\doxysubsection{Death Test Styles}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md111}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ \{c++\}}
\DoxyCodeLine{GTEST\_FLAG\_SET(death\_test\_style, "{}threadsafe"{});}

\end{DoxyCode}


You can do this in {\ttfamily \mbox{\hyperlink{namespacegoogle__benchmark_a3253acce1ef04aecc2bb76a6cd6edc1f}{main()}}} to set the style for all death tests in the binary, or in individual tests. Recall that flags are saved before running each test and restored afterwards, so you need not do that yourself. For example\+:
...
\DoxyCodeLine{  GTEST\_FLAG\_SET(death\_test\_style, "{}fast"{});}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md112}{}\doxysubsection{Caveats}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md112}
The {\ttfamily statement} argument of {\ttfamily ASSERT\+\_\+\+EXIT()} can be any valid C++ statement. If it leaves the current function via a {\ttfamily return} statement or by throwing an exception, the death test is considered to have failed. Some Google\+Test macros may return from the current function (e.\+g. {\ttfamily \mbox{\hyperlink{gtest_8h_ae9244bfbda562e8b798789b001993fa5}{ASSERT\+\_\+\+TRUE()}}}), so be sure to avoid them in {\ttfamily statement}.
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md113}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md113}
\{\+: .callout .note\} Note\+: If you want to put a series of test assertions in a subroutine to check for a complex condition, consider using \href{gmock_cook_book.md\#NewMatchers}{\texttt{ a custom GMock matcher}} instead. This lets you provide a more readable error message in case of failure and avoid all of the issues described below.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md114}{}\doxysubsection{Adding Traces to Assertions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md114}
...
\item Sometimes the line number of the trace point is enough for identifying the particular invocation of a sub-\/routine. In this case, you don\textquotesingle{}t have to choose a unique message for {\ttfamily SCOPED\+\_\+\+TRACE}. You can simply use {\ttfamily \char`\"{}\char`\"{}}.
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md115}{}\doxysubsection{Propagating Fatal Failures}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md115}
A common pitfall when using {\ttfamily ASSERT\+\_\+$\ast$} and {\ttfamily FAIL$\ast$} is not understanding that when they fail they only abort the {\itshape current function}, not the entire test. For example, the following test will segfault\+:
...
To alleviate this, Google\+Test provides three different solutions. You could use either exceptions, the {\ttfamily (ASSERT$\vert$\+EXPECT)\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE} assertions or the {\ttfamily Has\+Fatal\+Failure()} function. They are described in the following two subsections.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md116}{}\doxysubsubsection{Asserting on Subroutines with an exception}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md116}
...
This listener should be added after other listeners if you have any, otherwise they won\textquotesingle{}t see failed {\ttfamily On\+Test\+Part\+Result}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md117}{}\doxysubsubsection{Asserting on Subroutines}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md117}
As shown above, if your test calls a subroutine that has an {\ttfamily ASSERT\+\_\+$\ast$} failure in it, the test will continue after the subroutine returns. This may not be what you want.
...
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Fatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Nonfatal assertion   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Verifies    }\\\cline{1-3}
\endhead
{\ttfamily \mbox{\hyperlink{gtest_8h_a5034fda3490aad5a93942ac83f4cea49}{ASSERT\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE(statement)}};}   &{\ttfamily \mbox{\hyperlink{gtest_8h_a067c02ccaf3171d6e1781cd0f8cdcf74}{EXPECT\+\_\+\+NO\+\_\+\+FATAL\+\_\+\+FAILURE(statement)}};}   &{\ttfamily statement} doesn\textquotesingle{}t generate any new fatal failures in the current thread.   \\\cline{1-3}
\end{longtabu}
...
Assertions from multiple threads are currently not supported on Windows.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md118}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md118}
...
If {\ttfamily Has\+Fatal\+Failure()} is used outside of {\ttfamily \mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}}} , {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}}} , or a test fixture, you must add the {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}\+:\+:} prefix, as in\+:
...
Similarly, {\ttfamily Has\+Nonfatal\+Failure()} returns {\ttfamily true} if the current test has at least one non-\/fatal failure, and {\ttfamily Has\+Failure()} returns {\ttfamily true} if the current test has at least one failure of either kind.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md119}{}\doxysection{Logging Additional Information}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md119}
In your test code, you can call {\ttfamily Record\+Property(\char`\"{}key\char`\"{}, value)} to log additional information, where {\ttfamily value} can be either a string or an {\ttfamily int}. The {\itshape last} value recorded for a key will be emitted to the \href{\#generating-an-xml-report}{\texttt{ XML output}} if you specify one. For example, the test
...
\begin{DoxyItemize}
\item {\ttfamily Record\+Property()} is a static member of the {\ttfamily Test} class. Therefore it needs to be prefixed with {\ttfamily \mbox{\hyperlink{classtesting_1_1Test}{testing\+::\+Test}}\+:\+:} if used outside of the {\ttfamily TEST} body and the test fixture class.
\item $\ast${\ttfamily key}$\ast$ must be a valid XML attribute name, and cannot conflict with the ones already used by Google\+Test ({\ttfamily name}, {\ttfamily status}, {\ttfamily time}, {\ttfamily classname}, {\ttfamily type\+\_\+param}, and {\ttfamily value\+\_\+param}).
...
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md120}{}\doxysection{Sharing Resources Between Tests in the Same Test Suite}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md120}
...
\DoxyCodeLine{}
\DoxyCodeLine{    // If `shared\_resource\_` is **not deleted** in `TearDownTestSuite()`,}
\DoxyCodeLine{    // reallocation should be prevented because `SetUpTestSuite()` may be called}
\DoxyCodeLine{    // in subclasses of FooTest and lead to memory leak.}
\DoxyCodeLine{    //}
\DoxyCodeLine{    // if (shared\_resource\_ == nullptr) \{}
\DoxyCodeLine{    //   shared\_resource\_ = new ...;}
\DoxyCodeLine{    // \}}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{    shared\_resource\_ = nullptr;}
\DoxyCodeLine{  \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\};}
\DoxyCodeLine{}
\DoxyCodeLine{T* FooTest::shared\_resource\_ = nullptr;}
\DoxyCodeLine{}
...
\{\+: .callout .note\} NOTE\+: Though the above code declares {\ttfamily Set\+Up\+Test\+Suite()} protected, it may sometimes be necessary to declare it public, such as when using it with {\ttfamily TEST\+\_\+P}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md121}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md121}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  \string~Environment() override \{\}}
\DoxyCodeLine{}
...
Now, when {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}} is invoked, it first calls the {\ttfamily Set\+Up()} method. The tests are then executed, provided that none of the environments have reported fatal failures and {\ttfamily \mbox{\hyperlink{perf__counters__gtest_8cc_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} has not been invoked. Finally, {\ttfamily Tear\+Down()} is called.

Note that {\ttfamily Set\+Up()} and {\ttfamily Tear\+Down()} are only invoked if there is at least one test to be performed. Importantly, {\ttfamily Tear\+Down()} is executed even if the test is not run due to a fatal failure or {\ttfamily \mbox{\hyperlink{perf__counters__gtest_8cc_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}}.
...
You should call {\ttfamily \mbox{\hyperlink{namespacetesting_a460d7b998622e332392c1e00be3a60d5}{Add\+Global\+Test\+Environment()}}} before {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}} is called, probably in {\ttfamily \mbox{\hyperlink{namespacegoogle__benchmark_a3253acce1ef04aecc2bb76a6cd6edc1f}{main()}}}. If you use {\ttfamily gtest\+\_\+main}, you need to call this before {\ttfamily \mbox{\hyperlink{namespacegoogle__benchmark_a3253acce1ef04aecc2bb76a6cd6edc1f}{main()}}} starts for it to take effect. One way to do this is to define a global variable like this\+:
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md123}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md123}
...
\DoxyCodeLine{    public testing::TestWithParam<absl::string\_view> \{}
...
\DoxyCodeLine{                public testing::WithParamInterface<absl::string\_view> \{}
\DoxyCodeLine{  ...}
\DoxyCodeLine{\};}
...
Then, use the {\ttfamily TEST\+\_\+P} macro to define as many test patterns using this fixture as you want. The {\ttfamily \+\_\+P} suffix is for \char`\"{}parameterized\char`\"{} or \char`\"{}pattern\char`\"{}, whichever you prefer to think.
...
The parameter generator expression is not evaluated until Google\+Test is initialized (via {\ttfamily \mbox{\hyperlink{namespacetesting_afd726ae08c9bd16dc52f78c822d9946b}{Init\+Google\+Test()}}}). Any prior initialization done in the {\ttfamily main} function will be accessible from the parameter generator, for example, the results of flag parsing.
...
The following statement will instantiate all tests from {\ttfamily \mbox{\hyperlink{classFooTest}{Foo\+Test}}} again, each with parameter values {\ttfamily \char`\"{}cat\char`\"{}} and {\ttfamily \char`\"{}dog\char`\"{}} using the \href{reference/testing.md\#param-generators}{\texttt{ {\ttfamily Values\+In}}} parameter generator\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{ \{c++\}}
\DoxyCodeLine{constexpr absl::string\_view kPets[] = \{"{}cat"{}, "{}dog"{}\};}
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample7_unittest.cc}{\texttt{ sample7\+\_\+unittest.\+cc}} and \href{https://github.com/google/googletest/blob/main/googletest/samples/sample8_unittest.cc}{\texttt{ sample8\+\_\+unittest.\+cc}} for more examples.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md124}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md124}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest-param-test_8h_a6a5cb3ce0a0fe17f84f357a6f39a4ba5}{INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}}}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md125}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md125}
The optional last argument to {\ttfamily \mbox{\hyperlink{gtest-param-test_8h_a6a5cb3ce0a0fe17f84f357a6f39a4ba5}{INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}}} allows the user to specify a function or functor that generates custom test name suffixes based on the test parameters. The function should accept one argument of type {\ttfamily \mbox{\hyperlink{structtesting_1_1TestParamInfo}{testing\+::\+Test\+Param\+Info}}$<$class Param\+Type$>$}, and return {\ttfamily std\+::string}.
...
\DoxyCodeLine{}
\DoxyCodeLine{class MyTestSuite : public testing::TestWithParam<std::tuple<MyType, std::string>> \{}
\DoxyCodeLine{\};}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md126}{}\doxysection{Typed Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md126}
...
\DoxyCodeLine{ public:}
\DoxyCodeLine{  ...}
\DoxyCodeLine{  using List = std::list<T>;}
...
Then, use {\ttfamily \mbox{\hyperlink{gtest-typed-test_8h_ae6f575265873190de41b1329d16df0f0}{TYPED\+\_\+\+TEST()}}} instead of {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}}} to define a typed test for this test suite. You can repeat this as many times as you want\+:
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md127}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md127}
...
\DoxyCodeLine{template <typename T>}
\DoxyCodeLine{class FooTest : public testing::Test \{}
\DoxyCodeLine{  void DoSomethingInteresting();}
\DoxyCodeLine{  ...}
\DoxyCodeLine{\};}
...
Then, use {\ttfamily \mbox{\hyperlink{gtest-typed-test_8h_a6e9d1cd9b97da0076ae699775d3222d0}{TYPED\+\_\+\+TEST\+\_\+\+P()}}} to define a type-\/parameterized test. You can repeat this as many times as you want\+:
...
\DoxyCodeLine{}
\DoxyCodeLine{  // You will need to use `this` explicitly to refer to fixture members.}
...
In the special case where the type list contains only one type, you can write that type directly without {\ttfamily \mbox{\hyperlink{namespacetesting_a29eec4c1aba59e52881d8eb38cece83c}{testing\+::\+Types}}$<$...$>$}, like this\+:
...
You can see \href{https://github.com/google/googletest/blob/main/googletest/samples/sample6_unittest.cc}{\texttt{ sample6\+\_\+unittest.\+cc}} for a complete example.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md128}{}\doxysection{Testing Private Code}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md128}
...
\`{}\`{}\`{}c++ \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Test\+Suite\+Name, Test\+Name)}}; \`{}\`{}\`{}

For example,

\`{}\`{}\`{}c++ // foo.\+h class Foo \{ ... private\+: \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Foo\+Test, Bar\+Returns\+Zero\+On\+Null)}};

int Bar(void$\ast$ x); \};

// foo\+\_\+test.\+cc ... \mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST(\+Foo\+Test, Bar\+Returns\+Zero\+On\+Null)}} \{ Foo foo; EXPECT\+\_\+\+EQ(foo.\+Bar(\+NULL), 0); // Uses Foo\textquotesingle{}s private member Bar(). \} \`{}\`{}\`{}
...
class Foo \{ friend class \mbox{\hyperlink{classFooTest}{Foo\+Test}}; \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Foo\+Test, Bar)}}; \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Foo\+Test, Baz)}}; ... definition of the class Foo ... \};
...
\mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F(\+Foo\+Test, Bar)}} \{ ... \} \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F(\+Foo\+Test, Baz)}} \{ ... \}

\} // namespace \mbox{\hyperlink{namespacemy__namespace}{my\+\_\+namespace}} \`{}\`{}\`{}
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md129}{}\doxysection{\char`\"{}\+Catching\char`\"{} Failures}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md129}
...
to assert that {\ttfamily statement} generates a fatal (e.\+g. {\ttfamily ASSERT\+\_\+$\ast$}) failure in the current thread whose message contains the given {\ttfamily substring}, or use
...
if you are expecting a non-\/fatal (e.\+g. {\ttfamily EXPECT\+\_\+$\ast$}) failure.
...
\end{DoxyEnumerate}\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md130}{}\doxysection{Registering tests programmatically}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md130}
The {\ttfamily TEST} macros handle the vast majority of all use cases, but there are few where runtime registration logic is required. For those cases, the framework provides the {\ttfamily \mbox{\hyperlink{namespacetesting_ab6d0df219135565f957031449dde8dc0}{testing\+::\+Register\+Test}}} that allows callers to register arbitrary tests dynamically.
...
Must be called before {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}} is invoked, otherwise behavior is undefined.
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md131}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md131}
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md132}{}\doxysection{Extending Google\+Test by Handling Test Events}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md132}
Google\+Test provides an {\bfseries{event listener API}} to let you receive notifications about the progress of a test program and test failures. The events you can listen to include the start and end of the test program, a test suite, or a test method, among others. You may use this API to augment or replace the standard console output, replace the XML output, or provide a completely different form of output, such as a GUI or a database. You can also use test events as checkpoints to implement a resource leak checker, for example.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md133}{}\doxysubsection{Defining Event Listeners}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md133}
...
\DoxyCodeLine{   void OnTestStart(const testing::TestInfo\& test\_info) override \{}
...
\DoxyCodeLine{   void OnTestPartResult(const testing::TestPartResult\& test\_part\_result) override \{}
...
\DoxyCodeLine{   void OnTestEnd(const testing::TestInfo\& test\_info) override \{}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md134}{}\doxysubsection{Using Event Listeners}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md134}
To use the event listener you have defined, add an instance of it to the Google\+Test event listener list (represented by class \href{reference/testing.md\#TestEventListeners}{\texttt{ {\ttfamily Test\+Event\+Listeners}}} -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily \mbox{\hyperlink{namespacegoogle__benchmark_a3253acce1ef04aecc2bb76a6cd6edc1f}{main()}}} function, before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}}\+:
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default XML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md135}{}\doxysubsection{Generating Failures in Listeners}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md135}
You may use failure-\/raising macros ({\ttfamily EXPECT\+\_\+$\ast$()}, {\ttfamily ASSERT\+\_\+$\ast$()}, {\ttfamily \mbox{\hyperlink{gtest_8h_a3e26a8d27caa386ed0ea7ce9d5b7c4ed}{FAIL()}}}, etc) when processing an event. There are some restrictions\+:
...
See \href{https://github.com/google/googletest/blob/main/googletest/samples/sample10_unittest.cc}{\texttt{ sample10\+\_\+unittest.\+cc}} for an example of a failure-\/raising listener.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md136}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md136}
Google\+Test test programs are ordinary executables. Once built, you can run them directly and affect their behavior via the following environment variables and/or command line flags. For the flags to work, your programs must call {\ttfamily \mbox{\hyperlink{namespacetesting_afd726ae08c9bd16dc52f78c822d9946b}{testing\+::\+Init\+Google\+Test()}}} before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}}.

To see a list of supported flags and their usage, please run your test program with the {\ttfamily -\/-\/help} flag.

If an option is specified both by an environment variable and by a flag, the latter takes precedence.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md137}{}\doxysubsection{Selecting Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md137}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md138}{}\doxysubsubsection{Listing Test Names}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md138}
...
None of the tests listed are actually run if the flag is provided. There is no corresponding environment variable for this flag.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md139}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md139}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md140}{}\doxysubsubsection{Stop test execution upon first failure}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md140}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md141}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md141}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md142}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md142}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md143}{}\doxysubsection{Repeating the Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md143}
...
{\itshape If your test program contains \href{\#global-set-up-and-tear-down}{\texttt{ global set-\/up/tear-\/down}} code, it will be repeated in each iteration as well, as the flakiness may be in it. To avoid repeating global set-\/up/tear-\/down, specify {\ttfamily -\/-\/gtest\+\_\+recreate\+\_\+environments\+\_\+when\+\_\+repeating=false}\{.nowrap\}.}

{\itshape You can also specify the repeat count by setting the {\ttfamily GTEST\+\_\+\+REPEAT} environment variable.}

{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md144}{}\doxysubsection{Shuffling the Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md144}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md145}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md145}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md146}{}\doxysubsection{Controlling Test Output}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md146}
{\itshape  }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md147}{}\doxysubsubsection{Colored Terminal Output}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md147}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md148}{}\doxysubsubsection{Suppressing test passes}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md148}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md149}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md149}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md150}{}\doxysubsubsection{Suppressing UTF-\/8 Text Output}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md150}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md151}{}\doxysubsubsection{Generating an XML Report}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md151}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md152}{}\doxysubsubsection{Generating a JSON Report}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md152}
{\itshape  Google\+Test can also emit a JSON report as an alternative format to XML. To generate the JSON report, set the {\ttfamily GTEST\+\_\+\+OUTPUT} environment variable or the {\ttfamily -\/-\/gtest\+\_\+output} flag to the string {\ttfamily \char`\"{}json\+:path\+\_\+to\+\_\+output\+\_\+file\char`\"{}}, which will create the file at the given location. You can also just use the string {\ttfamily \char`\"{}json\char`\"{}}, in which case the output can be found in the {\ttfamily test\+\_\+detail.\+json} file in the current directory.}

{\itshape The report format conforms to the following JSON Schema\+:}

{\itshape 
\begin{DoxyCode}{0}
\DoxyCodeLine{\{}
\DoxyCodeLine{  "{}\$schema"{}: "{}https://json-\/schema.org/schema\#"{},}
...
\DoxyCodeLine{      "{}properties"{}: \{}
\DoxyCodeLine{        "{}name"{}: \{ "{}type"{}: "{}string"{} \},}
\DoxyCodeLine{        "{}file"{}: \{ "{}type"{}: "{}string"{} \},}
\DoxyCodeLine{        "{}line"{}: \{ "{}type"{}: "{}integer"{} \},}
\DoxyCodeLine{        "{}status"{}: \{}
...
{\itshape The report uses the format that conforms to the following Proto3 using the \href{https://developers.google.com/protocol-buffers/docs/proto3\#json}{\texttt{ JSON encoding}}\+:}
...
\DoxyCodeLine{  string name = 1;}
\DoxyCodeLine{  string file = 6;}
\DoxyCodeLine{  int32 line = 7;}
...
{\itshape \{\+: .callout .important\} IMPORTANT\+: The exact format of the JSON document is subject to change.}

{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md153}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md153}
{\itshape  }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md154}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md154}
...
{\itshape This feature is enabled only if the {\ttfamily TEST\+\_\+\+PREMATURE\+\_\+\+EXIT\+\_\+\+FILE} environment variable has been set.}

{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md155}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md155}
...
{\itshape To enable it, set the {\ttfamily GTEST\+\_\+\+BREAK\+\_\+\+ON\+\_\+\+FAILURE} environment variable to a value other than {\ttfamily 0}. Alternatively, you can use the {\ttfamily -\/-\/gtest\+\_\+break\+\_\+on\+\_\+failure} command line flag.}

{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md156}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md156}
...
{\itshape When debugging the test failures, however, you may instead want the exceptions to be handled by the debugger, such that you can examine the call stack when an exception is thrown. To achieve that, set the {\ttfamily GTEST\+\_\+\+CATCH\+\_\+\+EXCEPTIONS} environment variable to {\ttfamily 0}, or use the {\ttfamily -\/-\/gtest\+\_\+catch\+\_\+exceptions=0} flag when running the tests.}

{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md157}{}\doxysubsection{Sanitizer Integration}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md157}
{\itshape  The \href{https://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html}{\texttt{ Undefined Behavior Sanitizer}}, \href{https://github.com/google/sanitizers/wiki/AddressSanitizer}{\texttt{ Address Sanitizer}}, and \href{https://github.com/google/sanitizers/wiki/ThreadSanitizerCppManual}{\texttt{ Thread Sanitizer}} all provide weak functions that you can override to trigger explicit failures when they detect sanitizer errors, such as creating a reference from {\ttfamily nullptr}. To override these functions, place definitions for them in a source file that you compile as part of your main binary\+:}

{\itshape 
\begin{DoxyCode}{0}
\DoxyCodeLine{extern "{}C"{} \{}
\DoxyCodeLine{void \_\_ubsan\_on\_report() \{}
\DoxyCodeLine{  FAIL() << "{}Encountered an undefined behavior sanitizer error"{};}
\DoxyCodeLine{\}}
\DoxyCodeLine{void \_\_asan\_on\_error() \{}
\DoxyCodeLine{  FAIL() << "{}Encountered an address sanitizer error"{};}
\DoxyCodeLine{\}}
\DoxyCodeLine{void \_\_tsan\_on\_report() \{}
\DoxyCodeLine{  FAIL() << "{}Encountered a thread sanitizer error"{};}
\DoxyCodeLine{\}}
\DoxyCodeLine{\}  // extern "{}C"{}}
