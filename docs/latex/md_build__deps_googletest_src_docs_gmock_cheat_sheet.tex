\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md188}{}\doxysection{Defining a Mock Class}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md188}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MockClass}{}\doxysubsection{Mocking a Normal Class}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MockClass}
Given
...
\DoxyCodeLine{  \mbox{\hyperlink{gmock-function-mocker_8h_a05ffc29d0784b131ee178da190d31397}{MOCK\_METHOD}}(\textcolor{keywordtype}{string}, \mbox{\hyperlink{namespacetesting_1_1gmock__matchers__test_a738a538e1705ea49670aeb3ed25108e6}{Describe}}, (\textcolor{keyword}{const} \textcolor{keywordtype}{char}* name), (\textcolor{keyword}{override}));}
\DoxyCodeLine{  \mbox{\hyperlink{gmock-function-mocker_8h_a05ffc29d0784b131ee178da190d31397}{MOCK\_METHOD}}(\textcolor{keywordtype}{string}, \mbox{\hyperlink{namespacetesting_1_1gmock__matchers__test_a738a538e1705ea49670aeb3ed25108e6}{Describe}}, (\textcolor{keywordtype}{int} type), (\textcolor{keyword}{override}));}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} A mock object is currently naggy by default. We may make it nice by default in the future.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MockTemplate}{}\doxysubsection{Mocking a Class Template}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MockTemplate}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md189}{}\doxysubsection{Specifying Calling Conventions for Mock Functions}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md189}
...
where {\ttfamily STDMETHODCALLTYPE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_UsingMocks}{}\doxysection{Using Mocks in Tests}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_UsingMocks}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{namespacetesting_af6d1c13e9376c77671e37545cd84359c}{using ::testing::Return}};                          \textcolor{comment}{// \#1}}
\DoxyCodeLine{}
...
\DoxyCodeLine{      .WillRepeatedly(\mbox{\hyperlink{namespacetesting_af6d1c13e9376c77671e37545cd84359c}{Return}}(\textcolor{stringliteral}{"{}Category 5"{}}));}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_OnCall}{}\doxysection{Setting Default Actions}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_OnCall}
...
To customize the default action for a particular method of a specific mock object, use \href{reference/mocking.md\#ON_CALL}{\texttt{ {\ttfamily ON\+\_\+\+CALL}}}. {\ttfamily ON\+\_\+\+CALL} has a similar syntax to {\ttfamily EXPECT\+\_\+\+CALL}, but it is used for setting default behaviors when you do not require that the mock method is called. See \href{gmock_cook_book.md\#UseOnCall}{\texttt{ Knowing When to Expect}} for a more detailed discussion.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_ExpectCall}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_ExpectCall}
See \href{reference/mocking.md\#EXPECT_CALL}{\texttt{ {\ttfamily EXPECT\+\_\+\+CALL}}} in the Mocking Reference.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MatcherList}{}\doxysection{Matchers}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_MatcherList}
See the \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_matchers}{Matchers Reference}}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_ActionList}{}\doxysection{Actions}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_ActionList}
See the \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_actions}{Actions Reference}}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_CardinalityList}{}\doxysection{Cardinalities}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_CardinalityList}
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md190}{}\doxysection{Expectation Order}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md190}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md191}{}\doxysection{Verifying and Resetting a Mock}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md191}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md192}{}\doxysection{Mock Classes}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md192}
...
See this \href{gmock_cook_book.md\#UsingCheckPoints}{\texttt{ recipe}} for one application of it.\hypertarget{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md193}{}\doxysection{Flags}\label{md_build__deps_googletest_src_docs_gmock_cheat_sheet_autotoc_md193}
\tabulinesep=1mm
...
{\ttfamily -\/-\/gmock\+\_\+verbose=LEVEL}   &Sets the default verbosity level ({\ttfamily info}, {\ttfamily warning}, or {\ttfamily error}) of Google \mbox{\hyperlink{classMock}{Mock}} messages.   \\\cline{1-2}
\end{longtabu}
