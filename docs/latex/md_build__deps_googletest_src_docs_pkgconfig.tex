...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily \mbox{\hyperlink{sample3__unittest_8cc}{samples/sample3\+\_\+unittest.\+cc}}}.\hypertarget{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md298}{}\doxysubsection{CMake}\label{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md298}
...
pkg-\/config will also try to look in {\ttfamily PKG\+\_\+\+CONFIG\+\_\+\+PATH} to find {\ttfamily gtest\+\_\+main.\+pc}.\hypertarget{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md300}{}\doxysubsection{Using pkg-\/config in a cross-\/compilation setting}\label{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md300}
