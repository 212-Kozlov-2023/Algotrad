\href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ {\bfseries{Actions}}}} specify what a mock function should do when invoked. This page lists the built-\/in actions provided by Google\+Test. All actions are defined in the {\ttfamily \mbox{\hyperlink{namespacetesting}{testing}}} namespace.\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md322}{}\doxysection{Returning a Value}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md322}
\tabulinesep=1mm
...
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{namespacetesting_af6d1c13e9376c77671e37545cd84359c}{Return()}}}   &Return from a {\ttfamily void} mock function.    \\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md323}{}\doxysection{Side Effects}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md323}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md324}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md324}
...
\DoxyCodeLine{... \mbox{\hyperlink{namespacetesting_a620bba98fc80a3cda99b06b1f9221dc8}{Invoke}}(done) ...;  \textcolor{comment}{// This won't compile!}}
\DoxyCodeLine{}
\DoxyCodeLine{Closure* done2 = \textcolor{keyword}{new} BlockingClosure;}
\DoxyCodeLine{... \mbox{\hyperlink{namespacetesting_a620bba98fc80a3cda99b06b1f9221dc8}{Invoke}}(done2) ...;  \textcolor{comment}{// This works.}}
...
\DoxyCodeLine{...}
\DoxyCodeLine{InvokeArgument<2>(5, string(\textcolor{stringliteral}{"{}Hi"{}}), std::ref(\mbox{\hyperlink{namespacefoo}{foo}}))}

\end{DoxyCode}


calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md325}{}\doxysection{Default Action}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md325}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}}   &Do the default action (specified by {\ttfamily \mbox{\hyperlink{gmock-spec-builders_8h_a5b12ae6cf84f0a544ca811b380c37334}{ON\+\_\+\+CALL()}}} or the built-\/in one).   \\\cline{1-2}
\end{longtabu}


\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md326}{}\doxysection{Composite Actions}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md326}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md327}{}\doxysection{Defining Actions}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md327}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\cellcolor{\tableheadbgcolor}\textbf{ Macro   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{gmock-actions_8h_a7af7137aa4871df4235881af377205fe}{ACTION(\+Sum)}} \{ return arg0 + arg1; \}}   &Defines an action {\ttfamily Sum()} to return the sum of the mock function\textquotesingle{}s argument \#0 and \#1.    \\\cline{1-2}
{\ttfamily \mbox{\hyperlink{gmock-actions_8h_af5f47e069acb517db9f743f029471aa7}{ACTION\+\_\+\+P(\+Plus, n)}} \{ return arg0 + n; \}}   &Defines an action {\ttfamily Plus(n)} to return the sum of the mock function\textquotesingle{}s argument \#0 and {\ttfamily n}.    \\\cline{1-2}
...
The {\ttfamily ACTION$\ast$} macros cannot be used inside a function or class. 